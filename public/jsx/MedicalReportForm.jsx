class MedicalReportForm extends React.Component{
    send=()=>{
        ...
        axios.post('/medicalForm',send_param)
        .then((response)=>{
            alert(response.data);
    ...
    render(){     
        ...
        return (
            ...
            <div style={main}>
                ...
                <textarea style={textarea}  placeholder="가능한 자세히 입력하세요" ref={ref=>this.content=ref}>
                </textarea>
               
                <input  onClick={this.send}  style={input_type_submit} name="dsubmit" type="submit" value="Send"/>
